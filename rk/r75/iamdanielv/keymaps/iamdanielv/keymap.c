...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE_LYR] = LAYOUT(
        ...
        MY_GRV,    KC_1,      KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,  KC_HOME,
    ...
    [HRM_BASE_LYR] = LAYOUT(
        ...
        _______,   GUI_A,     ALT_S,    SFT_D,    CTL_F,    CTLG_G,   _______,  CTL_J,    SFT_K,    ALT_L,    HM_SCLN,  END_QUOT,           MY_ENT,   KC_PGDN,
        LSFT_LLCK, _______,   _______,  CTLS_C,   _______,  _______,  _______,  _______,  ALFT_COMM,ARGT_DOT, _______,  _______,            _______,
    ...
    [EXT_LYR] = LAYOUT(
        ...
        _______,   KC_LGUI,   KC_LALT,  KC_LSFT,  KC_LCTL,  C(KC_G),  KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_HOME,  KC_END,             _______,  KC_RCTL,
        LSFT_LLCK, MY_UNDO,   MY_CUT,   MY_COPY,  MY_PASTE, KC_SPC,   KC_BSPC,  KC_DEL,   MY_BACK,  MY_FWD,   _______,  _______,            KC_VOLU,
    ...
    [KBCTL_LYR] = LAYOUT(
        ...
        LSFT_LLCK, TD_KB_CLR, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  NK_TOGG,  XXXXXXX,  RM_VALD,  RM_VALU,  TG_EXT,   TG_HRM,             RM_VALU,
    ...
    [NUM_LYR] = LAYOUT(
        ...
        LSFT_LLCK, XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_P0,    KC_PDOT,  KC_PDOT,  KC_PSLS,  _______,            _______,
    ...
    [MEDIA_LYR] = LAYOUT(
        ...
        LSFT_LLCK, _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,   _______,   _______,                      _______,                                QK_LLCK,  _______,            _______,  _______,  _______
    )
};
