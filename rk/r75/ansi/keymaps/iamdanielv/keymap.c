...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WIN_LYR] = LAYOUT( // 0
        ...
        W_FN_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,   KC_PGDN,
    ...
    [_WIN_FN_LYR] = LAYOUT( // 1
        ...
        KC_GRV,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_DEL,   KC_END,
        MY_GRV,    MY_CONS,  MY_TASK,  C(KC_F),  C(KC_R),  C(KC_H),  KC_PGUP,  KC_HOME,  KC_UP,    KC_END,   KC_PSCR,  KC_SCRL,  KC_PAUS,  KC_INS,   KC_SCRL,
    ...
    [_CTL_LYR] = LAYOUT( // 2
        _______,   _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  RM_TOGG,  QK_LLCK,
        XXXXXXX,   TD_KB_RST, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  RM_HUED,  RM_HUEU,  RGB_M_P,  RM_PREV,  RM_NEXT,  RM_TOGG,  TG_NUM,
        XXXXXXX,   XXXXXXX,   XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  RM_SATD,  RM_SATU,  RM_SPDD,  RM_SPDU,            _______,  TG_W_FN,
        XXXXXXX,   TD_KB_CLR, XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  NK_TOGG,  XXXXXXX,  RM_VALD,  RM_VALU,  _______,  TG_W_FN,            RM_VALU,
        KC_SWP_FN, XXXXXXX,   XXXXXXX,                      XXXXXXX,                                TG_NUM,   _______,            RM_SPDD,  RM_VALD,  RM_SPDU
    ),
    [_NUM_LYR] = LAYOUT( // 3
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        XXXXXXX,  _______,  _______,  _______,  _______,  _______,  KC_NUM,   KC_P7,    KC_P8,    KC_P9,    KC_PAST,  _______,  _______,  _______,  XXXXXXX,
        XXXXXXX,  KC_BTN1,  KC_MS_U,  KC_BTN2,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_P4,    KC_P5,    KC_P6,    KC_PPLS,  _______,  _______,  _______,  TG_NUM,
        XXXXXXX,  KC_MS_L,  KC_MS_D,  KC_MS_R,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_P1,    KC_P2,    KC_P3,    KC_PENT,  _______,            _______,  XXXXXXX,
        XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_P0,    KC_PDOT,  KC_PDOT,  KC_PSLS,  _______,            _______,
